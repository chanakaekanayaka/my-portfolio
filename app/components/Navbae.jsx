...
const Navbae = () => {
  return (
    <>
    <div className='fixed top-0 right-0 left-0 w-full -z-10 translate-y-[-80]'>
    ...
    flex items-center justify-between z-50'>
        ...
        rounded-full px-12 py-4  font-medium text-teal-700 shadow-lg bg-opacity-50 hover:bg-teal-50'>
